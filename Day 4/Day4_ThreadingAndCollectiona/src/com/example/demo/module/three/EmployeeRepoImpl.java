...
public class EmployeeRepoImpl implements EmployeeRepository<Employee> {
	...
	@Override
	public boolean add(Employee emp) throws ElementsAlreadyExistException, NotFoundException {
		if(emp==null)
			return false;
		Employee employee = findById(emp.getEmployeeId());
		if(employee!=null)
			return update(employee, emp);
		employees.add(emp);
		return true;
	}
...
//		return itr.next();
	...
	@Override
	public boolean update(Employee original, Employee emp) throws NotFoundException {
