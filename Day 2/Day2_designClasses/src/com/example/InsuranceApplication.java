...
public class InsuranceApplication {
	...
	public static Insurance insuranceFactory(int key, Scanner scanner) {
		...
		switch(key) {
		case 1:{
			System.out.print("Enter Policy Holder DOB : ");
		...
		case 2:{
			System.out.print("Enter Policy Vehicle Engine Capacity : ");
	...
	public static void main(String []args) {
		...
		Insurance check = insuranceFactory(3,scanner);
		System.out.println(" Life : "+ life.toString()+"   Premium : "+  service.findPremium(life));
		System.out.println("Vehicle : "+ vehicle.toString()+ "   Premium : " +  service.findPremium(vehicle));
	}
}
