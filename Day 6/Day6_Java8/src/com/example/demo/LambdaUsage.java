...
//		});
		...
		Function<Double, Double> milesToKms = (e) -> 1.60934*e;
				
		Function<Double, Double> celToFaren = (e) -> e*9.0/5.0 + 32.0;
		
		System.out.println(calculate(milesToKms, 1));
		System.out.println(calculate(celToFaren, 0));
		
		
		
		BiPredicate<Boolean, Boolean> andGate = (a,b) -> a && b;
		
		System.out.println("True, False : " + andGate.test(true, false));
		
		BiPredicate<Boolean, Boolean> orGate = (a,b) -> a || b;
		
		System.out.println("True, False : " +orGate.test(true, false));
		
		BiPredicate<Integer, Integer> testForGrt = (mark,condition) -> mark>condition;
		
		System.out.println("marks Grater Than 80 :> " + testForGrt.test(50, 80));
		System.out.println("marks Grater Than 80 :> " + testForGrt.test(90, 80));
		
		
		BiPredicate<String, String> testForAmp = (email, criteria) -> email.contains(criteria);
		System.out.println(testForAmp.test("bhumuragrawal@gmail", "@"));
		
		
		//using the default method 
		
		Predicate<String> testContainsBandC = (t) -> t.contains("b") && t.contains("c");
		System.out.println(testContainsBandC.and(testForChar).test("Hellobc"));
		System.out.println(testContainsBandC.or(testForChar).test("Hellobc"));
