...
public class CustomerRepoImpl implements CrudRepository<Customer> {
	...
	private String removeSql2 = "delete from customer where customerid = 125";
	...
	public boolean addAll(Customer ...customers) {
		try(PreparedStatement query = con.prepareStatement(insertSql)) {
			...
			PreparedStatement query1 = con.prepareStatement(removeSql);
			query.addBatch(removeSql2);
			int []choices = query.executeBatch();
